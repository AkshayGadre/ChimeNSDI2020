function [out1,out2,out3,out4,out5,out6,out7,out8,goodness] = AngleEstimation6BS4MP(channels,xstart,xend,ystart,yend,frequencies,minDistance,maxDistance,stepSize)
...
d6prime=norm([a2 b2 z]-L6);
                    for a3=a2-2:0.2:a2+2
                        for b3=b2-2:.2:b2+2
                            ...
                            d6primeprime=norm([a3 b3 z]-L6);
                             for a4=a2-2:0.2:a2+2
                                for b4=b2-2:0.2:b2+2
                   ...
                   alpha1=channels*pinv(e);
                   goodness(round((a3-a2+2.2)*5),round((b3-b2+2.2)*5),round((a4-a2+2.2)*5),round((b4-b2+2.2)*5))=(1/norm(channels-alpha1*e));
                                end
                             end
                        end
                    end
...
[maxval, maxidx] = max(goodness(:));
[out5,out6,out7,out8] = ind2sub( size(goodness), maxidx );
